...
const LOG_SOURCE: string = 'PercentFieldCustomizerFieldCustomizer';

export default class PercentFieldCustomizerFieldCustomizer
  extends BaseFieldCustomizer<IPercentFieldCustomizerFieldCustomizerProperties> {
